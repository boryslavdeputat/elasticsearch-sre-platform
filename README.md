# Elasticsearch / OpenSearch SRE Platform
...
SRE patterns for **Elasticsearch / OpenSearch**: ILM/ISM, shard strategy, snapshot restore, rolling upgrades, hot-warm-cold.

## Contents

- `docs/SHARD_STRATEGY.md`
- `docs/ILM_ISM.md`
- `docs/SNAPSHOT_RESTORE.md`
- `docs/ROLLING_UPGRADE.md`
- `scripts/cluster_health.py`
- `examples/ism-policy.example.json`
